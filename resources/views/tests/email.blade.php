...
<head>
    ...
    <title>Bienvenido al Boletín de El León Verde</title>
</head>
<body style="font-size: 14px">
    ...
    <p> Haremos de esta una súper aventura donde todos aprenderemos mucho y la pasaremos increíble.</p>
                
    <p>Te recomiendo algunos artículos populares de mi <a href="https://elleonverde.com/blog-verde" style="color:green"><b>BLOG</b></a></p> 
        
    <p>No te olvides hacer las cosas con el corazón y con mucha pasión. </p> 
        
    <p><b>Un fuerte abrazo. <br/>
        Arturo, El León Verde.</b></p>    
</body>
</html>