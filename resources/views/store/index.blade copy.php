                        ...
                        <div class="col-xl-12">
                            <div class="news_detail_left">
                                <div class="block-title" style="margin-bottom:7px">
                                    <p>Tienda en Europa</p>
                                    <h2 style="color:#404a3d; font-weight:600">Venta de semillas, abono orgánico, sustratos, herbicidas y fungicidas orgánicos herramientas, accesorios y libros para tu huerto o jardín</h2>
                                    <div class="leaf">
                                        <img src="assets/images/resources/leaf.png" alt="">
                                    </div>
                                </div>
                                <div class="news_detail_image_box">
                                    <img src="/assets/images/about/store-el-leon-verde.jpg" alt="">
                                </div>
                                <br>
                                <div class="news_detail_content">
                                    ...
                                    <p>Compra con seguridad y confianza. </p>
                                    <p>
                                        Al lado izquierdo en el menú encontrarás los productos distribuidos en categorías.
                                    </p>
                    ...
                    <div class="single-sidebar" data-wow-delay="0.3s"
                        ...
                        <div class="categories-box">
                            ...
                            <ul class="categories clearfix">
                                @foreach($categories as $category)
                                <li style="line-height:35px"><a href="#">{{ $category->category }}</a></li>
                                @endforeach
                            </ul>
                        </div>
                    </div>
